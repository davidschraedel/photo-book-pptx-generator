...
SOURCE_TEMPLATE = Path("temp_template.pptx")
...
def fit_and_center(img_path, box_left, box_top, box_width, box_height):
        ...
        for ph, photo_path in zip(placeholders, group):
            ...
            try:
                ...
                if "unsupported image format" in str(e):
                    # If pptx rejects the format (e.g., MPO, WEBP), convert to standard JPEG in memory
